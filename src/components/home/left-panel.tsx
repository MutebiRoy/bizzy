    ...
    <div className="flex flex-col h-screen overflow-hidden chat-container">
      {isViewingConversation && selectedConversation ? (
        <div className="flex flex-col h-full w-full relative">
          {/* Header - Chat View*/}
          <header className="sticky top-0 left-0 w-full z-20 bg-blue-500 conversations-list-view-headers">
        ...
        <div className="flex flex-col h-full w-full">
          ...
          <header className="sticky top-0 left-0 w-full z-20 conversations-list-view-headers">
